...
namespace NewPaymentAPI.Controllers
{
    ...
    public class PayementDetailController : ControllerBase
    {
        ...
        public PayementDetailController(PaymentDetailContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != payementDetail.PayementId)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<PayementDetail>> PostPayementDetail(PayementDetail payementDetail)
        {
            ...
            return CreatedAtAction("GetPayementDetail", new { id = payementDetail.PayementId }, payementDetail);
        }
        ...
        {
            return _context.PayementDetails.Any(e => e.PayementId == id);
        }
    }
}
